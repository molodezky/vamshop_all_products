...
$main_content = $vamTemplate->fetch(CURRENT_TEMPLATE.'/module/products_catalog.html');

$vamTemplate->assign('language', $_SESSION['language']);
$vamTemplate->assign('main_content', $main_content);
$vamTemplate->caching = 0;
if (!defined(RM)) $vamTemplate->loadFilter('output', 'note');
$template = (file_exists('templates/'.CURRENT_TEMPLATE.'/'.FILENAME_PRODUCTS_CATALOG.'.html') ? CURRENT_TEMPLATE.'/'.FILENAME_PRODUCTS_CATALOG.'.html' : CURRENT_TEMPLATE.'/index.html');
